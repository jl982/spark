 ...
 */
private[spark] class TorrentDriverBroadcast[T: ClassTag](obj: T, id: Long)
  extends TorrentBroadcast[T](id) with Logging with Serializable {
  ...
  override protected val numBlocks: Int = writeBlocks(obj)
  ...
  override protected def readAndProcessBlocks(): T = {
    setConf(SparkEnv.get.conf)
